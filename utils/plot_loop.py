...
ax1.axhline(80, color=C_FILTERED, lw=0.6, ls=":", alpha=0.6, zorder=2)
ax1.axhline(-80, color=C_FILTERED, lw=0.6, ls=":", alpha=0.6, zorder=2)
ax1.axhline(200, color=C_FILTERED, lw=0.5, ls=":", alpha=0.35, zorder=2)
ax1.axhline(-200, color=C_FILTERED, lw=0.5, ls=":", alpha=0.35, zorder=2)
...
ax1.text(t_max, 80, "  ±80 lock", va="center", fontsize=7, color=C_FILTERED, alpha=0.8)
ax1.text(t_max, -80, "  ±80 lock", va="center", fontsize=7, color=C_FILTERED, alpha=0.8)
ax1.text(t_max, 200, "  ±200 unlock", va="center", fontsize=7, color=C_FILTERED, alpha=0.5)
ax1.text(t_max, -200, "  ±200 unlock", va="center", fontsize=7, color=C_FILTERED, alpha=0.5)
...
ax2.legend(handles=lines2, loc="upper left", fontsize=8)
...
ax3.legend(handles=lines3, loc="upper left", fontsize=8)
...
ax4.legend(handles=lines4, loc="upper left", fontsize=8)
